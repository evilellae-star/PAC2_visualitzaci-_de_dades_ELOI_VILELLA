...
| **Circular Dendrogram** | Representació jeràrquica circular per mostrar relacions i proximitat entre especies de eukaryotes. | [`docs/circular_dendrogram.png`](docs/circular_dendrogram.png) |
